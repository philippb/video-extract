...
class OutputGenerator:
    ...
    def _create_markdown_content(
        ...
        lines.append("")
        lines.append("*Complete analysis including slide screenshots, OCR text extraction, spoken content transcription, and AI-powered summaries.*")
        lines.append("")
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Generated by video-extract - AI-powered video analysis tool*")
        lines.append("")
        lines.append("**Legend:**")
        lines.append("- 📄 OCR text shows exactly what text appears on each slide")
        lines.append("- 🎤 Transcript shows what was spoken during each slide segment") 
        ...
        if ocr_text:
            ...
            if ocr_confidence > 0:
                ...
                if ocr_confidence < 0.5:
                    confidence_note += " ⚠️ *Low confidence - text may be inaccurate*"
